...
import org.xylan.mailspy.core.integration.common.xml.XPathUtils;

import static org.hamcrest.Matchers.emptyString;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.delete;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;
import static org.xylan.mailspy.core.integration.common.matchers.MailSpyMatchers.isValidUuid;
        ...
        runWithSecurity(
            ...
            (context, mockMvc) -> {
                mockMvc.perform(get("/mailspy/resources/index.html"))
                    ...
                    .andExpect(xpath("//meta[@name='csrf_token']/@content").string(isValidUuid()));
            });
    }
