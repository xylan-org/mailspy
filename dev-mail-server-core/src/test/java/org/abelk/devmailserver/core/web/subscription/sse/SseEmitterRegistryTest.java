...
public class SseEmitterRegistryTest {
    ...
    @InjectMocks
    private SseEmitterRegistry underTest;
    ...
    public void createEmitterShouldSendConnectedEvent() {
        ...
        assertTrue(sseEventIterator.next().getData().equals("data:"));
        assertTrue(sseEventIterator.next().getData().equals("connected"));
        assertTrue(sseEventIterator.next().getData().equals("\nevent:connected\n\n"));
    }
    ...
    public void broadcastShouldSendGivenDataThroughAliveEmitters() {
        ...
        Iterator<DataWithMediaType> sseEventIterator = getSseEventIterator();
        assertTrue(sseEventIterator.next().getData().equals("event:testEvent\ndata:"));
        assertTrue(sseEventIterator.next().getData().equals("testData"));
    }
